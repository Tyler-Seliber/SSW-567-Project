...
class TestMRTD(unittest.TestCase):
    ...
    def test_scanMRZ(self, mockedDocument):
        ...
        # Test 4
        mockedDocument.return_value = ['P<ALBFRANKLIN<<ARNOLD<SWOLE<<<<<<<<<<<<<<<<<', 'MN6JC8BV39ALB4912251M09103184UR757JNNONF8FM6']
        doc = None
        output = MRTD.scanMRZ(doc)
        self.assertEqual(['P<ALBFRANKLIN<<ARNOLD<SWOLE<<<<<<<<<<<<<<<<<', 'MN6JC8BV39ALB4912251M09103184UR757JNNONF8FM6'], output)
    ...
    def test_decodeMRZ(self):
        ...
        # Test 9 - Personal number max 15 characters
        line1 = 'P<ALBFRANKLIN<<ARNOLD<SWOLE<<<<<<<<<<<<<<<<<'
        line2 = 'MN6JC8BV39ALB4912251M09103184UR757JNNONF8FM6'
        expected = {'document_type': 'P', 'issuing_country': 'ALB', 'last_name': 'FRANKLIN', 'first_name': 'ARNOLD', 'middle_name': 'SWOLE', 'passport_number': 'MN6JC8BV3', 'passport_number_check_digit': '9', 'country_code': 'ALB', 'birth_date': '491225', 'birth_date_check_digit': '1', 'sex': 'M', 'expiration_date': '091031', 'expiration_date_check_digit': '8', 'personal_number': '4UR757JNNONF8FM', 'personal_number_check_digit': '6'}
        actual = MRTD.decodeMRZ(line1, line2)
        self.assertEqual(expected, actual)
    ...
    def test_encode_travel_info(self, mockedDBentry):
        ...
        # Test 1
        mockedDBentry.return_value = {'document_type': 'P', 'issuing_country': 'UTO', 'last_name': 'ERIKSSON', 'first_name': 'ANNA', 'middle_name': 'MARIA', 'passport_number': 'L898902C3', 'passport_number_check_digit': '6', 'country_code': 'UT0', 'birth_date': '740812', 'birth_date_check_digit': '2', 'sex': 'F', 'expiration_date': '120415', 'expiration_date_check_digit': '9', 'personal_number': 'ZE184226B<<<<<<', 'personal_number_check_digit': '1'}
        personal_number = 'ZE184226B'
        expected = ['P<UTOERIKSSON<<ANNA<MARIA<<<<<<<<<<<<<<<<<<<', 'L898902C36UT07408122F1204159ZE184226B<<<<<<1']
        actual = MRTD.encodeTravelInfo(personal_number)
        self.assertEqual(expected, actual)

        # Test 2
        mockedDBentry.return_value = {'document_type': 'P', 'issuing_country': 'ITA', 'last_name': 'PEPPERONI', 'first_name': 'JOHNNY', 'middle_name': 'DONNY', 'passport_number': '067FIKKXO', 'passport_number_check_digit': '7', 'country_code': 'ITA', 'birth_date': '840118', 'birth_date_check_digit': '6', 'sex': 'M', 'expiration_date': '921104', 'expiration_date_check_digit': '1', 'personal_number': 'T8W3UK289<<<<<<', 'personal_number_check_digit': '7'}
        personal_number = 'T8W3UK289'
        expected = ['P<ITAPEPPERONI<<JOHNNY<DONNY<<<<<<<<<<<<<<<<', '067FIKKXO7ITA8401186M9211041T8W3UK289<<<<<<7']
        actual = MRTD.encodeTravelInfo(personal_number)
        self.assertEqual(expected, actual)

        # Test 3
        mockedDBentry.return_value = {'document_type': 'P', 'issuing_country': 'FRA', 'last_name': 'BAGUETTE', 'first_name': 'OUI', 'middle_name': '', 'passport_number': '4J5S0UCIU', 'passport_number_check_digit': '4', 'country_code': 'FRA', 'birth_date': '150630', 'birth_date_check_digit': '3', 'sex': 'F', 'expiration_date': '370808', 'expiration_date_check_digit': '6', 'personal_number': '64U4CO5DC<<<<<<', 'personal_number_check_digit': '8'}
        personal_number = '64U4CO5DC'
        expected = ['P<FRABAGUETTE<<OUI<<<<<<<<<<<<<<<<<<<<<<<<<<', '4J5S0UCIU4FRA1506303F370808664U4CO5DC<<<<<<8']
        actual = MRTD.encodeTravelInfo(personal_number)
        self.assertEqual(expected, actual)

        # Test 4
        mockedDBentry.return_value = {'document_type': 'P', 'issuing_country': 'ALB', 'last_name': 'FRANKLIN', 'first_name': 'ARNOLD', 'middle_name': 'SWOLE', 'passport_number': 'MN6JC8BV3', 'passport_number_check_digit': '9', 'country_code': 'ALB', 'birth_date': '491225', 'birth_date_check_digit': '1', 'sex': 'M', 'expiration_date': '091031', 'expiration_date_check_digit': '8', 'personal_number': 'A9X<<<<<<<<<<<<', 'personal_number_check_digit': '0'}
        personal_number = 'A9X'
        expected = ['P<ALBFRANKLIN<<ARNOLD<SWOLE<<<<<<<<<<<<<<<<<', 'MN6JC8BV39ALB4912251M0910318A9X<<<<<<<<<<<<0']
        actual = MRTD.encodeTravelInfo(personal_number)
        self.assertEqual(expected, actual)

        # Test 5
        mockedDBentry.return_value = {'document_type': 'P', 'issuing_country': 'ALB', 'last_name': 'FRANKLIN', 'first_name': 'ARNOLD', 'middle_name': 'SWOLE', 'passport_number': 'MN6JC8BV3', 'passport_number_check_digit': '9', 'country_code': 'ALB', 'birth_date': '491225', 'birth_date_check_digit': '1', 'sex': 'M', 'expiration_date': '091031', 'expiration_date_check_digit': '8', 'personal_number': 'FT8AO29BHY861<<<', 'personal_number_check_digit': '2'}
        personal_number = 'FT8AO29BHY861'
        expected = ['P<ALBFRANKLIN<<ARNOLD<SWOLE<<<<<<<<<<<<<<<<<', 'MN6JC8BV39ALB4912251M0910318FT8AO29BHY861<<<2']
        actual = MRTD.encodeTravelInfo(personal_number)
        self.assertEqual(expected, actual)

        # Test 6
        mockedDBentry.return_value = {'document_type': 'P', 'issuing_country': 'ALB', 'last_name': 'FRANKLIN', 'first_name': 'ARNOLD', 'middle_name': 'SWOLE', 'passport_number': 'MN6JC8BV3', 'passport_number_check_digit': '9', 'country_code': 'ALB', 'birth_date': '491225', 'birth_date_check_digit': '1', 'sex': 'M', 'expiration_date': '091031', 'expiration_date_check_digit': '8', 'personal_number': '4UR757JNNONF8FM', 'personal_number_check_digit': '6'}
        personal_number = '4UR757JNNONF8FM'
        expected = ['P<ALBFRANKLIN<<ARNOLD<SWOLE<<<<<<<<<<<<<<<<<', 'MN6JC8BV39ALB4912251M09103184UR757JNNONF8FM6']
        actual = MRTD.encodeTravelInfo(personal_number)
        self.assertEqual(expected, actual)
